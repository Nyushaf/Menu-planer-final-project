        ...
        <div>
            {userWeek.map((week) => (
                <div key = {week._id} className="accordion">
                    ...
                    <p className="week-name">Week: {week.weekName} <span className="label-position"><AiFillEdit className="edit-delete-btn" onClick={() => onEditWeek(week._id, week.weekName, week.days)} /> <AiFillDelete className="edit-delete-btn" onClick={() => onDeleteWeek(week._id)} /> </span></p>
                    </label>
